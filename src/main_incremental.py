...
def main(argv=None):
    tstart = time.time()
    # Arguments
    parser = argparse.ArgumentParser(description='GATF camera-ready continual learning runner')

    # miscellaneous args
    parser.add_argument('--gpu', type=int, default=0,
                        help='GPU (default=%(default)s)')
    parser.add_argument('--results-path', type=str, default='../results_gatf',
    ...
    # training args
    parser.add_argument('--approach', default='gatf', type=str, choices=approach.__all__,
